...
console.log(temp)
    ...
    const humidade = splitted[1]
    const temperatura = splitted[0]
    //console.log(temperatura, humidade);//Printa o dado recebido no console
    ...
    io.sockets.emit('temp', {date: data, time: hora, temp:temperatura, humi:humidade}); //Emite o objeto temp, com os atributos date, time e temp
});
